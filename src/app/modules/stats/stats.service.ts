...
const getUserStats = async () => {
    ...
    const [
        ...
        totalInActiveUsers,
        totalBlockedUsers,
        newUsersInLast7Days, newUsersInLast30Days,
        usersByRole
    ] = await Promise.all([
        totalUsersPromise,
...
const getTourStats = async () => {
    ...
    const [
        ...
        totalTourByTourType,
        avgTourCost,
        totalTourByDivision, totalHighestBookedTour
    ] = await Promise.all([
        totalTourPromise,
...
const getBookingStats = async () => {
    ...
    const [
        ...
        bookingsPerTour, avgGuestCountPerBooking, bookingsLast7Days,
        bookingsLast30Days, totalBookingByUniqueUsers
    ] = await Promise.all([
        totalBookingPromise,
